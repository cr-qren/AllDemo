...
void Conv2DAccel(FpgaDevice *dev, int height, int width, int num_channels,
                 int num_filters, int kernel_size, int block_size, bool use_padding, bool use_max_pool_2x2,
                 bool use_bias, bool use_relu, bool use_bn, size_t input_addr, size_t coeff_addr,
                 size_t output_addr, size_t bias_addr, size_t a_addr, size_t b_addr);
/* 
void Conv2DAccel(FpgaDevice *dev, int height, int width, int num_channels,
                 int num_filters, int kernel_size, bool use_max_pool_2x2,
                 bool use_bias, bool use_relu, size_t input_addr,
